...
export const metadata: Metadata = {
  ...
  description:
    "Exclusive Off Road Caravan Listing Page Sponsorship for pop top caravan advertisers. Limited to just 1 advertiser per month — maximum exposure, retargeting included, and 100% share of voice in the pop top caravan category.",
}
          ...
          <div className="takeover_box">
            <div className="row g-0 max-width-6xl mx-auto">
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Be one of only two brands shown to highly interested pop top caravan buyers.</p>
              </div>
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Reach thousands of serious pop top caravan enthusiasts searching for their next model.</p>
              </div>
