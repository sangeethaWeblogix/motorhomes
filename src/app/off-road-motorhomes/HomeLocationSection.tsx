...
const FILTERS = [
  ...
  },
  {
    ...
    label: " By Weight (GVM)",
    items: [
      { text: "Under 1500kg", href: "/listings/off-road-category/under-1500-kg-gvm/" },
      { text: "Under 2000kg", href: "/listings/off-road-category/under-2000-kg-gvm/" },
      { text: "Under 2500kg", href: "/listings/off-road-category/under-2500-kg-gvm/" },
      { text: "Under 3000kg", href: "/listings/off-road-category/under-3000-kg-gvm/" },
      { text: "Over 3000kg",  href: "/listings/off-road-category/over-3000-kg-gvm/" },
    ],
  },
  {
...
export default function HomeLocationSection() {
      ...
      <div className="container">
        ...
        <div className="hloc-header">
          <h2 className="hloc-title">
            Find Off Road Motorhomes by <span className="hloc-title-accent">Popular Location</span>
          </h2>
          <p className="hloc-subtitle">Browse off road motorhomes near you by major Australian cities.</p>
  ...
  <h2 className="hloc-title">
           Search Off Road Motorhomes <span className="hloc-title-accent">Your Way</span>
          </h2>
