...
const OR_FAQ = [
  ...
  { q: "Do I need a special vehicle to tow an off road motorhome?", a: "Yes. Off road motorhomes are heavier and wider than standard motorhomes. You'll need a high-capacity 4WD with a tow bar rated to the motorhome'sGVM. Always check the motorhome'sGVM and the tow vehicle's GVM and tow rating before purchasing." },
